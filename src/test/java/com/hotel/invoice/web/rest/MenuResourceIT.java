...
class MenuResourceIT {
    ...
    private static final Boolean DEFAULT_ITEM_AVAILABLE = false;
    private static final Boolean UPDATED_ITEM_AVAILABLE = true;
    ...
    public static Menu createEntity(EntityManager em) {
        Menu menu = new Menu()
            ...
            .itemAvailable(DEFAULT_ITEM_AVAILABLE);
        return menu;
    }
    ...
    public static Menu createUpdatedEntity(EntityManager em) {
        Menu menu = new Menu()
            ...
            .itemAvailable(UPDATED_ITEM_AVAILABLE);
        return menu;
    }
    ...
    void createMenu() throws Exception {
        ...
        assertThat(testMenu.getIsVeg()).isEqualTo(DEFAULT_IS_VEG);
        assertThat(testMenu.getItemAvailable()).isEqualTo(DEFAULT_ITEM_AVAILABLE);
    }
    ...
    void getAllMenus() throws Exception {
        ...
        restMenuMockMvc
            ...
            .andExpect(jsonPath("$.[*].itemAvailable").value(hasItem(DEFAULT_ITEM_AVAILABLE.booleanValue())));
    }
    ...
    void getMenu() throws Exception {
        ...
        restMenuMockMvc
            ...
            .andExpect(jsonPath("$.itemAvailable").value(DEFAULT_ITEM_AVAILABLE.booleanValue()));
    }
    ...
    void putExistingMenu() throws Exception {
        ...
        assertThat(testMenu.getIsVeg()).isEqualTo(UPDATED_IS_VEG);
        assertThat(testMenu.getItemAvailable()).isEqualTo(UPDATED_ITEM_AVAILABLE);
    }
