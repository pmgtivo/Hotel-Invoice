...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './hotel.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_HOTEL_LIST actions', async () => {
    ...
    it('dispatches FETCH_HOTEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_HOTEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_HOTEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_HOTEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_HOTEL actions', async () => {
      const expectedActions = [
        {
