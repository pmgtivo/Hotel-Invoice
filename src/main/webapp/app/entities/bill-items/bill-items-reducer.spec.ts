...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BILLITEMS_LIST actions', async () => {
    ...
    it('dispatches FETCH_BILLITEMS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BILLITEMS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BILLITEMS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BILLITEMS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BILLITEMS actions', async () => {
      const expectedActions = [
        {
