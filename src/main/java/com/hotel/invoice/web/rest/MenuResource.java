...
import com.hotel.invoice.repository.MenuRepository;
...
/**
 * REST controller for managing {@link com.hotel.invoice.domain.Menu}.
 */
@RestController
@RequestMapping("/api")
@Transactional
    ...
    public ResponseEntity<Menu> partialUpdateMenu(
        ...
        Optional<Menu> result = menuRepository
            ...
            .map(existingMenu -> {
                ...
                if (menu.getIsVeg() != null) {
                    existingMenu.setIsVeg(menu.getIsVeg());
                }
                if (menu.getItemAvailable() != null) {
                    existingMenu.setItemAvailable(menu.getItemAvailable());
                }
