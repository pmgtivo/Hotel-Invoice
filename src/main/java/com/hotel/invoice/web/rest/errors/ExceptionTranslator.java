package com.hotel.invoice.web.rest.errors;
...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof com.hotel.invoice.service.EmailAlreadyUsedException ||
            ex instanceof com.hotel.invoice.service.UsernameAlreadyUsedException
        ) {
        ...
        if (ex instanceof com.hotel.invoice.service.InvalidPasswordException) return (ProblemDetailWithCause) new InvalidPasswordException()
            .getBody();
    ...
    private boolean containsPackageName(String message) {
        ...
        return StringUtils.containsAny(message, "org.", "java.", "net.", "jakarta.", "javax.", "com.", "io.", "de.", "com.hotel.invoice");
    }
}
